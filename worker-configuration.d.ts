/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e9f31bb2d8a3d5aba703426f93ab4220)
// Runtime types generated with workerd@1.20250523.0 2025-05-27 nodejs_compat_v2
declare namespace Cloudflare {
	interface Env {
		AUTH_SECRET: string;
		AUTH_URL: string;
		FIREFLY_III_BASE_URL: string;
		FIREFLY_III_OAUTH_CLIENT_ID: string;
		FIREFLY_III_OAUTH_CLIENT_SECRET: string;
